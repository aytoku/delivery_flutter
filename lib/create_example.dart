...
class CreateEx extends StatelessWidget {
  @override
...
class CreateExPage extends StatelessWidget{

  GlobalState _store = GlobalState.instance;
  TextEditingController _name;
  final FirebaseUser user;

  CreateExPage({this.user});
                    ...
                    child: Column(
                      children: <Widget>[
                        Padding(
                          ...
                          child: Row(
                            children: <Widget>[
                              Text(phone_number, style: TextStyle(color: Colors.grey, fontSize: 15)),
                            ],
                          ),
                        ),
                      ],
